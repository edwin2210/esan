...
@section('hcontent')
    ...
    @push('scripts')
        <script src="{{asset('js/web/admin/products/create.js')}}"></script>
    @endpush
    <div class="container-fluid web-form p-0">
        ...
        <form id="web-admin-products-create-form">
            @csrf
            <div class="row text-center justify-content-center m-0">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-4 m-0 p-2">
                    ...
                    <hr>
                    <input id="web-admin-products-create-inp-name" class="fz-md ht-inp" name="name" type="text" style="width: 80%" placeholder="Nombre" required>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-4 m-0 p-2">
                    <p class="fw-1 fz-xl">
                        Económico
                    ...
                    <hr>
                    <input id="web-admin-products-create-inp-price" class="fz-md ht-inp" name="price" type="number" step="0.01" style="width: 50%" placeholder="Precio" required>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-4 m-0 p-2">
                    <p class="fw-1 fz-xl">
                        Extras
                    ...
                    <hr>
                    <textarea id="web-admin-products-create-inp-description" name="description" cols="20" rows="10" class="fz-md ht-inp" placeholder="Descripción" required></textarea>
                </div>
