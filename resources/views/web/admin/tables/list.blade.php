...
@section('hcontent')
    <!--########## Section: Tables - List ##########-->
    @push('scripts')
        <script src="{{asset('js/web/admin/tables/list.js')}}"></script>
    @endpush
    <div class="container-fluid web-ht-list p-0">
        <div class="row align-items-center justify-content-center mx-0 my-2 my-sm-3 my-md-4 my-lg-5 my-xl-5 my-xxl-5">
            ...
            <div class="col-4 col-sm-4 col-md-2 col-lg-3 col-xl-4 col-xxl-4 m-0 p-0 text-center">
                <a class="fw-2 fz-xxl ht-txt-title" href="{{route('web.admin.tables.create-view')}}">
        ...
        <div class="row text-center justify-content-center m-0 px-1 px-sm-3 px-md-3 px-lg-3 px-xl-4 px-xxl-5">
            <table class="table align-middle">
                <thead>
                <tr>
                    <form id="web-admin-tables-list-form">
                        ...
                        <th scope="col" class="fw-1 fz-md">
                            <input class="fz-sm ht-inp mb-1 w-75 ht-locked" name="capacity" type="text" disabled/>
                            <br/><br/>
                            Capacidad
                        </th>
                ...
                <tbody id="web-admin-tables-list-table">
                </tbody>
            </table>
        </div>
    </div>
