...
@section('hcontent')
    ...
    @if($order->deleted_at == null)
        @push('scripts')
            <script src="{{asset('js/web/manager/orders/view.js')}}"></script>
        @endpush
        <div class="container-fluid web-ht-view p-0">
            <div class="row align-items-center justify-content-center mx-0 my-2 my-sm-3 my-md-4 my-lg-5 my-xl-5 my-xxl-5">
                <div class="col-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-3 m-0 p-0 text-center">
                    <a class="fw-2 fz-xxl ht-txt-title" href="{{route('web.manager.orders.list')}}">
                ...
                <div class="col-1 col-sm-1 col-md-1 col-lg-3 col-xl-3 col-xxl-3 m-0 p-0 text-center">
                    <a class="fw-2 fz-xxl ht-txt-title mx-md-2 mx-lg-3 mx-xl-4 mx-xxl-5" href="{{route('web.manager.orders.edit-view', ['id' => $order->id])}}">
                        <i class="fa fa-pen" aria-hidden="true"></i>
                    </a>
                    <br class="d-lg-none"><br class="d-lg-none">
                    <a id="web-manager-orders-view-delete" class="fw-2 fz-xxl ht-txt-error mx-md-2 mx-lg-3 mx-xl-4 mx-xxl-5" href="#">
            ...
            <div class="row text-center justify-content-center m-0">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-4 m-0 p-2">
                    <p class="fw-1 fz-xl">
                        Mesero
                        <input type="hidden" id="web-manager-orders-view-id" value="{{$order->id}}">
                    </p>
                    <hr>
            ...
            <div class="row text-center justify-content-center m-0">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-4 m-0 p-2">
                    <hr>
                    <button id="web-manager-orders-view-collect" class="ht-btn ht-btn-lg ht-btn-orange">
                        Cobrar orden
                    </button>
                </div>
            </div>
