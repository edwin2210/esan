...
@section('hcontent')
    <!--########## Section: Orders - List ##########-->
    @push('scripts')
        <script src="{{asset('js/web/manager/orders/list.js')}}"></script>
    @endpush
    <div class="container-fluid web-ht-list p-0">
        ...
        <div class="row text-center justify-content-center m-0 px-1 px-sm-3 px-md-3 px-lg-3 px-xl-4 px-xxl-5">
            <table class="table align-middle">
                <thead>
                <tr>
                    <form id="web-manager-orders-list-form">
                        ...
                        <th scope="col" class="fw-1 fz-md">
                            <input class="fz-sm ht-inp mb-1 w-75 ht-locked" name="waiter" type="text" disabled/>
                            <br/><br/>
                            Mesero
                        </th>
                        <th scope="col" class="fw-1 fz-md">
                ...
                <tbody id="web-manager-orders-list-table">
                </tbody>
            </table>
        </div>
    </div>
